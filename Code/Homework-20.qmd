...
Based on what you see in the bar chart, how would you describe the pattern of SOM between the 4 different forests?

Write your answer here: The four different forests have varying mean percent soil organic matter with Degrasse having the lowest and the Kip Tract having the highest.

standard deviations increase along with the mean percent soil organic matter but I do not know if this is relevant or how i would interpret this if it is.
...
-   how would you describe the pattern of SOM between the 4 different forests?
    ...
    The plot displays varying levels of percent SOM, with once again Degrasse having the lowest mean and the Kip Tract the highest.

-   What do you notice that is different from how the data were displayed in the bar plot?

    This plot shows the distribution of the data, including the presence of outlier or other points that lay far outside the mean that may contribute in skewing the data.

-   Which plot type is more informative? Explain your answer.

    The box-and-whisker was more informative because it shows the distribution of the data and therefore we can see both singular observations and ones that may influence the overall mean.
